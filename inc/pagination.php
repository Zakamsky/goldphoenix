...
if ( ! function_exists( 'goldphoenix_pagination' ) ) {
	/**
	 ...
	 */
	function goldphoenix_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'goldphoenix' ),
				'next_text'          => __( '&raquo;', 'goldphoenix' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'goldphoenix' ),
			)
		);
