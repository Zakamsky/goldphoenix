...
add_action( 'after_setup_theme', 'goldphoenix_woocommerce_support' );
if ( ! function_exists( 'goldphoenix_woocommerce_support' ) ) {
	/**
	 * Declares WooCommerce theme support.
	 */
	function goldphoenix_woocommerce_support() {
		...
		add_filter( 'woocommerce_form_field_args', 'goldphoenix_wc_form_field_args', 10, 3 );
	}
}
 ...
 */
add_action( 'woocommerce_before_main_content', 'goldphoenix_woocommerce_wrapper_start', 10 );
add_action( 'woocommerce_after_main_content', 'goldphoenix_woocommerce_wrapper_end', 10 );
...
if ( ! function_exists( 'goldphoenix_woocommerce_wrapper_end' ) ) {
	function goldphoenix_woocommerce_wrapper_end() {
		echo '</main><!-- #main -->';
 ...
 * @return mixed
 */
if ( ! function_exists( 'goldphoenix_wc_form_field_args' ) ) {
	function goldphoenix_wc_form_field_args( $args, $key, $value = null ) {
