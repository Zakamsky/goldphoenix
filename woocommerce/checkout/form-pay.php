	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'goldphoenix' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'goldphoenix' ); ?></th>
			</tr>
		</thead>
		<tbody>
