...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login flex-grow-1" method="post">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				...
				<input class="w-100 woocommerce-Input woocommerce-Input--text form-control" type="password" name="password" id="password" autocomplete="current-password" />
			</p>
			...
			<p class="form-row">
                <div class="custom-control custom-checkbox mb-3">
                    ...
                    <label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme custom-control-label" for="rememberme">
                        <?php esc_html_e( 'Remember me', 'woocommerce' ); ?>
                    </label>
                </div>
<!--	todo-delete:			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">-->
<!--					<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span>--><?php //esc_html_e( 'Remember me', 'woocommerce' ); ?><!--</span>-->
<!--				</label>-->
				<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit mb-3" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</p>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="col-lg-5 d-flex flex-column">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register flex-grow-1" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
